...
//  Texture: Flightsk.png, Attacksk.png, Deathsk.png
// ════════════════════════════════════════════════════════════
#include <SFML/Graphics.hpp>

#include "IMonster.hpp"

enum class SkeletonState { Chase, Attack, TakeHit, Death };
...
class Skeleton : public IMonster {
 public:
  ...
  explicit Skeleton(sf::Vector2f pos);
 ...
 private:
  SkeletonState state_ = SkeletonState::Chase;
  int frame_ = 0;
  float timer_ = 0.f;
